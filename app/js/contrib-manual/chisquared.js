...
define([], function(){
  ...
  function ChiSquared(){
    /* Empty constructor, this really just provides class functions. */
  }


  /* BEGIN Found code at https://www.fourmilab.ch/rpkp/experiments/analysis/chiCalc.html */
  ...
  */
  ...
  /* END Found code at https://www.fourmilab.ch/rpkp/experiments/analysis/chiCalc.html */
  /* Thanks! */
  
  /* Export as class functions. */

  ChiSquared.poz = poz;
  ChiSquared.ex = ex;
  ChiSquared.pochisq = pochisq;
  ChiSquared.critchi = critchi;
